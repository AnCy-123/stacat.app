...
var userne = localStorage.getItem("username");
document.getElementById("name").innerHTML = "Welcome " + userne + "!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
function getData() {
    firebase.database().ref().on('value', function (snapshot) {
        ...
        snapshot.forEach(function (childSnapshot) {
            ...
            var row = "<div class='inner' id=" + roomnames + " onclick='redirectToRoom(this.id)'> " + roomnames + " - Created By " + userne + " On " + date.getDate() + " / " 
